...
$allowFilesTypes = array('pdf', 'doc', 'docx', 'jpg', 'jpeg', 'png');
...
if(isset($_POST['submit'])){
    ...
    if(empty($valErr)){
        ...
        if(in_array($fileType, $allowFilesTypes)){
            ...
            $uploadStatus = 0;
            $statusMsg = 'Sorry, only '.implode('/', $allowFilesTypes).' files are allowed to upload';
        }   
    }
    ...
    if($uploadStatus == 1){
        ...
        if(!empty($uploadedFile) && file_exists($uploadedFile)){
            ...
            if(is_file($uploadedFile)){
                ...
                "\"\n" .
                "Content-Desciption: ".basename($uploadedFile)."\n" .
